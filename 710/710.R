...
columns <- list(scan=1, pressure=2, temperature=3, temperature2=4, conductivity=5,
                conductivity2=6, oxygen=7, ph=8, oxygen2=9, fluorescence=10,
                parirradiance=11, oxygen3=12, oxygen4=13, salinity=14, salinity2=15,
                sigmat=16, sigmat2=17, oxygen3=18)
