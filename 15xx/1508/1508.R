...
par(mfrow=c(2,2))
plot(g0[['time']], g0[['pressure']], xlim=focus) # OK
plot(g1[['time']], g1[['pressure']], xlim=focus) # OK
plot(g2[['time']], g2[['pressure']], xlim=focus) # OK
oce.plot.ts(g2[['time']], g2[['pressure']], xlim=focus) # FAILS
