...
latLook <- 0:10
mapPoints(topoWorld[["longitude"]][rep(ix, length(latLook))], topoWorld[["latitude"]][iy+latLook])
par(mar=c(3, 3, 1, 1), mgp=c(2, 0.7, 0))
plot(topoWorld[["latitude"]][iy+latLook], topoWorld[["z"]][ix, iy+latLook],ylab="z", xlab="Lat", pch=20,
     ylim=c(-1000,0))
text(topoWorld[["latitude"]][iy+latLook], topoWorld[["z"]][ix, iy+latLook]-20, topoWorld[["z"]][ix, iy+latLook], pos=1, srt=90)
