...
#mapPlot(coastlineWorld, projection="+proj=wintri +lon_0=0", fill='lightgray')
mapPlot(coastlineWorld, projection="+proj=wintri +lon_0=70", fill='lightgray')
look <- lat < -60
...
aa <- data.frame(lon=AAlon, lat=AAlat)
save(aa, file="aa.rda")
