...
# alsk gives overplotted coastlines; not recommended
...
mapPlot(coastlineWorld, projection=p, longitudelim=c(-80, 0), latitudelim=c(0, 60))
mtext(p, line=line, adj=1, col=pcol, font=font)
mtext("Extraneous merdians", line=line, adj=0, col=ecol, font=font)
...
mtext(p, line=line, adj=1, col=pcol, font=font)
mtext("Redraws globe", line=line, adj=0, col=ecol, font=font)
...
mapPlot(coastlineWorld, projection=p, longitudelim=c(-80, 0), latitudelim=c(0, 60))
mtext(p, line=line, adj=1, col=pcol, font=font)
mtext("Extraneous horiz. lone", line=line, adj=0, col=ecol, font=font)
...
mtext(p, line=line, adj=1, col=pcol, font=font)
mtext("Overplots world", line=line, adj=0, col=ecol, font=font)
...
mapPlot(coastlineWorld, projection=p, longitudelim=c(-80,0), latitudelim=c(0,45))
mtext(p, line=line, adj=1, col=pcol, font=font)
mtext("Extraneous line", line=line, adj=0, col=ecol, font=font)
...
mapPlot(coastlineWorld, projection=p, longitudelim=c(-80,0), latitudelim=c(0,60))
mtext(p, line=line, adj=1, col=pcol, font=font)
mtext("Extraneous meridians", line=line, adj=0, col=ecol, font=font)
